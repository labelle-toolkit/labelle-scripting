...
// labelle-scripting#44): scripts/swarm.rs drives three of these through
// `labelle::batch2` — one contract crossing per direction per tick
// instead of a get/set per entity. Declared like components/hunger.rs
